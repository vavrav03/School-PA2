...
int Timestamp::getYear() const { return date.getYear(); }

int Timestamp::getMonth() const { return date.getMonth(); }

int Timestamp::getDay() const { return date.getDay(); }

int Timestamp::getHour() const { return time.getHour(); }

int Timestamp::getMinute() const { return time.getMinute(); }

int Timestamp::getSecond() const { return time.getSecond(); }
...
DataType *Timestamp::clone() const { return new Timestamp(*this); }
