 ...
 */
std::vector<std::string> indexMapToVector(const std::unordered_map<std::string, size_t> &map);
 ...
 */
std::unordered_map<std::string, size_t> vectorToIndexMap(const std::vector<std::string> &vector);
 ...
 */
bool mapsContainSameKey(const std::unordered_map<std::string, size_t> &a, const std::unordered_map<std::string, size_t> &b);
